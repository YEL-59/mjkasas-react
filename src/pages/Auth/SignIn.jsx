...
//   // Extract values and methods from form
...
//             {/* Role Selection */}
//             <div>
//               <label className="block text-[#000] font-medium mb-1">Select Role</label>
//               <div className="flex space-x-2">
//                 {roles.map((role) => (
//                   <button
//                     key={role}
...
//                     className={`flex-1 py-2 px-4 rounded-[10px] border transition-colors ${form.getValues("role") === role
//                         ? "border-orange-400 bg-orange-50 text-orange-600"
//                         : "border-gray-300 text-gray-800 hover:bg-gray-50"
//                       }`}
//                   >
...
//             {/* Email */}
//             <div>
//               <label className="block text-[#000] font-medium mb-1">Email Address</label>
//               <input
//                 type="email"
//                 {...register("email")}
//                 placeholder="Enter your email address"
...
//             {/* Password */}
//             <div>
//               <label className="block text-[#000] font-medium mb-1">Password</label>
//               <div className="relative">
//                 <input
//                   type={showPassword ? "text" : "password"}
//                   {...register("password")}
...
//               type="submit"
//               disabled={isPending}
//               className={`w-full mt-10 ${isPending ? "bg-gray-400" : "bg-black hover:bg-gray-900"} text-white font-semibold py-2 rounded-md`}
//             >
//               {isPending ? "Logging in..." : "Log in"}
//             </button>
//           </form>
