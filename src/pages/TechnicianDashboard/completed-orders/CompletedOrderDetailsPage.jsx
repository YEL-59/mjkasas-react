...
const CompletedOrderDetailsPage = () => {
    ...
    const technicians = Array.isArray(workOrder.technicians) ? workOrder.technicians : [];
    const completedBy = technicians?.[0]?.name || "";
    const hazardousCleanup = workOrder.hazardous_cleanup ? "Yes" : "No";
    const beforePhotos = (workOrder.galleries || []).filter((g) => g.type === 'before');
    const afterPhotos = (workOrder.galleries || []).filter((g) => g.type === 'after');
        ...
        <div className="max-w-full mx-auto p-6 space-y-8">
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-start justify-between">
                    <div>
                        ...
                        <p className="text-gray-600">Work Order ID: {workOrder.uid || workOrder.id} • {workOrder.status}</p>
                    </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className='flex flex-col items-start space-x-2'>
                            ...
                            <span className="ml-2 text-gray-600">{workOrder.follow_up_date}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg mt-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                        <p className="text-gray-700 leading-relaxed">{workOrder.complete_note}</p>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between bg-white rounded-lg mt-6">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-gray-900 font-medium">Work Order Completed</span>
                    </div>
